...
import { faqSection as faqSectionService } from '../../../services/bakeryPageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { BakeryFaqEntry as FaqEntry } from '../../../types/bakeryPage';
...
const EDIT_PATH = '/cms/industries/bakery-confectionery/faq-section';

/** MAX_BAKERY_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function BakeryFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the Bakery & Confectionery page FAQ.'
