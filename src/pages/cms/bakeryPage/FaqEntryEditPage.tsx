...
import type {
  CreateBakeryFaqEntryInput as CreateFaqEntryInput,
  BakeryFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/industries/bakery-confectionery/faq-section';
...
export default function BakeryFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public Bakery & Confectionery page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the Bakery & Confectionery page."
        actions={
          <Button
            variant="secondary"
