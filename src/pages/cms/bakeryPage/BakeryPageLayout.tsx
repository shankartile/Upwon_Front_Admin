...
const SECTIONS = [
  ...
  { id: 'helps-section', label: 'How UpWON Helps' },
...
export const BAKERY_PAGE_BASE = '/cms/industries/bakery-confectionery';

export default function BakeryPageLayout() {
  ...
  return (
    <>
      <PageHeader
        title="Bakery & Confectionery Page"
        description="Content for the public UpWon Bakery & Confectionery industry page, section by section."
      />
      <Tabs
        tabs={SECTIONS.map((s) => ({ id: s.id, label: s.label }))}
        active={active}
        onChange={(id) => navigate(`${BAKERY_PAGE_BASE}/${id}`)}
      />
      <div className="mt-5">
        <Outlet />
      </div>
