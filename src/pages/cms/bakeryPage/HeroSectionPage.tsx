...
import type { BakeryHeroSlide } from '../../../types/bakeryPage';

/**
 * Bakery hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/industries/bakery-confectionery/hero-section';

/** MAX_BAKERY_HERO_SLIDES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = 12;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: BakeryHeroSlide }
  | { kind: 'status'; record: BakeryHeroSlide; next: ContentStatus };

export default function BakeryHeroSectionPage() {
  const [entries, setEntries] = useState<BakeryHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the Bakery & Confectionery page slider.'
