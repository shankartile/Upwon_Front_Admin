...
import type { CreatePosProofLogoInput, PosProofLogo } from '../../../types/posPage';
...
const LOGO_ENTITY_TYPE = 'pos_proof_logo';
...
const toForm = (logo: PosProofLogo): Form => ({
  alt: logo.alt,
  status: logo.status,
...
export default function PosProofLogoEditPage() {
  ...
  const [logo, setLogo] = useState<PosProofLogo | null>(null);
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreatePosProofLogoInput = {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One mark in the wall inside the proof card."
        actions={
          <Button
            variant="secondary"
