...
import type { PosGrowthTier } from '../../../types/posPage';
...
const EDIT_PATH = '/cms/products/pos/growth-section/tiers';

/** MAX_POS_GROWTH_TIERS on the server. Shown before the 409 fires. */
const MAX_TIERS = 4;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: PosGrowthTier }
  | { kind: 'status'; record: PosGrowthTier; next: ContentStatus };

export default function GrowthTiersCard() {
  const [tiers, setTiers] = useState<PosGrowthTier[]>([]);
