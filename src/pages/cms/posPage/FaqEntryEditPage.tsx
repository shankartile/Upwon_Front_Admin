...
import type {
  CreatePosFaqEntryInput as CreateFaqEntryInput,
  PosFaqEntry as FaqEntry,
} from '../../../types/posPage';
...
const LIST_PATH = '/cms/products/pos/faq-section';
...
export default function PosFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public POS page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the POS page."
        actions={
          <Button
            variant="secondary"
