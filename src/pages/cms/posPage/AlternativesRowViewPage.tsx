...
export default function PosAlternativesRowViewPage() {
                        ...
                        return (
                          ...
                          >
                            {cell === null ? (
                              ...
                              // Zero is a real answer: the grid draws it as the
                              // em dash that means "not available natively".
                              <span className="tabular-nums">
                                {cell.rating === 0 ? '—' : `${cell.rating} / 5`}
                              </span>
                            ) : (
                              cell.content
                            )}
