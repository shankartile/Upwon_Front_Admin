...
import type { PosHeroSlide } from '../../../types/posPage';

/**
 * POS hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/products/pos/hero-section';
...
type Pending =
  | { kind: 'delete'; record: PosHeroSlide }
  | { kind: 'status'; record: PosHeroSlide; next: ContentStatus };

export default function PosHeroSectionPage() {
  const [entries, setEntries] = useState<PosHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the POS page slider.'
