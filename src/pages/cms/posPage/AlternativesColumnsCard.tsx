...
import type { PosAlternativesColumn } from '../../../types/posPage';
...
const EDIT_PATH = '/cms/products/pos/alternatives-section/columns';

/** MAX_COMPARISON_COLUMNS on the server. Shown before the 409 fires. */
const MAX_COLUMNS = 6;

type Pending =
  | { kind: 'delete'; record: PosAlternativesColumn }
  | { kind: 'status'; record: PosAlternativesColumn; next: ContentStatus };
...
export default function AlternativesColumnsCard() {
  ...
  return (
    <section className="mt-8">
      ...
      <DataTable<PosAlternativesColumn>
        data={columns}
        loading={loading}
