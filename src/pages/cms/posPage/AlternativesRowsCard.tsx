...
const EDIT_PATH = '/cms/products/pos/alternatives-section/rows';

/** MAX_COMPARISON_ROWS on the server. Shown before the 409 fires. */
const MAX_ROWS = 12;

type Pending =
  | { kind: 'delete'; record: PosAlternativeRow }
  | { kind: 'status'; record: PosAlternativeRow; next: ContentStatus };
...
export default function AlternativesRowsCard() {
  ...
  const filledCount = (row: PosAlternativeRow) => {
