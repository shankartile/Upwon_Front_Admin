...
/**
 * The growth-path line under the row of cards.
 *
 ...
 *
 * Unlike the FMS page's, this line is drawn with an orange half, so it takes
 * the same **like this** accent markup the headings do.
 */
  ...
  const run = async () => {
    ...
    try {
      if (pending === 'clear') {
        ...
        toast.success('Line saved', 'The public POS page now shows it.');
      }
      await load();
    } catch (error) {
          ...
          <Field
            ...
            hint={
              stored === null
                ...
                : 'Shown centred under the row, in small bold type. Wrap words as **like this** to draw them in orange.'
            }
          >
            <Textarea
              rows={2}
      ...
      <ConfirmDialog
        ...
        description={
          pending === 'clear'
            ...
            : 'Are you sure you want to save this line? The public POS page will show it straight away.'
        }
