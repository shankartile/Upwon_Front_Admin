...
import type { HreasyHeroSlide } from '../../../types/hreasyPage';

/**
 * HREasy hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/products/hreasy/hero-section';

/** MAX_ERP_HERO_SLIDES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = 12;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: HreasyHeroSlide }
  | { kind: 'status'; record: HreasyHeroSlide; next: ContentStatus };

export default function HreasyHeroSectionPage() {
  const [entries, setEntries] = useState<HreasyHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the HREasy page slider.'
