...
const EDIT_PATH = '/cms/products/hreasy/packages-section/tiers';

/** MAX_HREASY_PACKAGE_TIERS on the server. Shown before the 409 fires. */
const MAX_TIERS = 4;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: HreasyPackageTier }
  | { kind: 'status'; record: HreasyPackageTier; next: ContentStatus };

export default function PackageTiersCard() {
  const [tiers, setTiers] = useState<HreasyPackageTier[]>([]);
