...
import type {
  CreateHreasyFaqEntryInput as CreateFaqEntryInput,
  HreasyFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/products/hreasy/faq-section';
...
export default function HreasyFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public HREasy page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the HREasy page."
        actions={
          <Button
            variant="secondary"
