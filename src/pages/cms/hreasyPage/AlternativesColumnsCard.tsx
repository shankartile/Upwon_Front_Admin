...
import type { HreasyAlternativesColumn } from '../../../types/hreasyPage';
...
const EDIT_PATH = '/cms/products/hreasy/alternatives-section/columns';

/** MAX_COMPARISON_COLUMNS on the server. Shown before the 409 fires. */
const MAX_COLUMNS = 6;

type Pending =
  | { kind: 'delete'; record: HreasyAlternativesColumn }
  | { kind: 'status'; record: HreasyAlternativesColumn; next: ContentStatus };
...
export default function AlternativesColumnsCard() {
  ...
  return (
    <section className="mt-8">
      ...
      <DataTable<HreasyAlternativesColumn>
        data={columns}
        loading={loading}
