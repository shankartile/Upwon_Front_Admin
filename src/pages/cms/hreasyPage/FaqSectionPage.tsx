...
import { faqSection as faqSectionService } from '../../../services/hreasyPageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { HreasyFaqEntry as FaqEntry } from '../../../types/hreasyPage';
...
const EDIT_PATH = '/cms/products/hreasy/faq-section';

/** MAX_ERP_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function HreasyFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the HREasy page FAQ.'
