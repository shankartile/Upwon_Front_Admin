...
import { NON_FOOD_FMCG_LIMITS, type NonFoodFmcgTrustLogo } from '../../../types/nonFoodFmcgPage';

/**
 * The customer logos in the trust section - the scrolling marquee under
 * "Trusted by non-food FMCG brands".
 *
...
const EDIT_PATH = '/cms/industries/non-food-fmcg/trust-section/logos';

/** MAX_NON_FOOD_FMCG_TRUST_LOGOS on the server. Shown as a hint before the 409 fires. */
const MAX_LOGOS = NON_FOOD_FMCG_LIMITS.trustLogos;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: NonFoodFmcgTrustLogo }
  | { kind: 'status'; record: NonFoodFmcgTrustLogo; next: ContentStatus };

export default function TrustLogosCard() {
  const [logos, setLogos] = useState<NonFoodFmcgTrustLogo[]>([]);
  ...
  return (
    <section className="mt-8">
      ...
      <DataTable<NonFoodFmcgTrustLogo>
        data={logos}
        loading={loading}
