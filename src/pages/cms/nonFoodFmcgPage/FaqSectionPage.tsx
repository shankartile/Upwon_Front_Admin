...
import { faqSection as faqSectionService } from '../../../services/nonFoodFmcgPageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { NonFoodFmcgFaqEntry as FaqEntry } from '../../../types/nonFoodFmcgPage';

/**
 * ERP FAQ admin - the question list.
 *
...
const EDIT_PATH = '/cms/industries/non-food-fmcg/faq-section';

/** MAX_NON_FOOD_FMCG_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function NonFoodFmcgFaqSectionPage() {
  ...
  return (
    <>
      ...
      <DataTable<FaqEntry>
        ...
        emptyDescription={
          isNarrowed
            ...
            : 'Add the first question — until then this section is hidden on the public page.'
        }
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ? 'This removes the question and its answer from the section and the public page. The record is kept for audit, but no longer appears in this list.'
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the Non-Food FMCG page FAQ.'
