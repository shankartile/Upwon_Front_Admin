...
import { ctaSection as service } from '../../../services/nonFoodFmcgPageService';
...
import type { NonFoodFmcgCtaSection, UpsertNonFoodFmcgCtaSectionInput } from '../../../types/nonFoodFmcgPage';

/**
 * The Non-Food FMCG page's closing band.
 *
...
const IMAGE_ENTITY_TYPE = 'non_food_fmcg_cta_image';

/**
 * Field rules, mirroring the server-side nonFoodFmcg closing band validator.
 *
...
const toForm = (section: NonFoodFmcgCtaSection): Form => ({
...
export default function NonFoodFmcgCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'nonFoodFmcgCtaDesktop' : 'nonFoodFmcgCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertNonFoodFmcgCtaSectionInput = {
        ...(desktopImageFileId
      ...
      setSubmitted(false);
      toast.success('Closing band saved', 'The public Non-Food FMCG page now shows this content.');
    } catch (error) {
  ...
  return (
    <>
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.nonFoodFmcgCtaDesktop.hint}
              >
                <ArtworkPicker
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.nonFoodFmcgCtaMobile.hint}
              >
                <ArtworkPicker
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public Non-Food FMCG page will show the new content straight away.'
