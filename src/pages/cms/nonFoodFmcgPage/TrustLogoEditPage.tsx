...
import type { CreateNonFoodFmcgTrustLogoInput, NonFoodFmcgTrustLogo } from '../../../types/nonFoodFmcgPage';
...
const LOGO_ENTITY_TYPE = 'non_food_fmcg_trust_logo';

/**
 * Field rules, mirroring the server-side nonFoodFmcg trust section validator.
 *
...
const toForm = (logo: NonFoodFmcgTrustLogo): Form => ({
  alt: logo.alt,
  status: logo.status,
...
export default function NonFoodFmcgTrustLogoEditPage() {
  ...
  const [logo, setLogo] = useState<NonFoodFmcgTrustLogo | null>(null);
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreateNonFoodFmcgTrustLogoInput = {
      ...
      if (isNew) {
        ...
        toast.success(
          'Logo updated',
          'The public Non-Food FMCG page now shows this wall.',
        );
      }
      navigate(LIST_PATH);
    } catch (error) {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this logo? The public Non-Food FMCG page will show it straight away.'
        }
