...
import type {
  CreateNonFoodFmcgFaqEntryInput as CreateFaqEntryInput,
  NonFoodFmcgFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/industries/non-food-fmcg/faq-section';
...
export default function NonFoodFmcgFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public Non-Food FMCG page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the Non-Food FMCG page."
        actions={
          <Button
            variant="secondary"
