...
import type { NonFoodFmcgTrustStat, CreateNonFoodFmcgTrustStatInput } from '../../../types/nonFoodFmcgPage';
...
const toForm = (stat: NonFoodFmcgTrustStat): Form => ({
  value: stat.value,
  label: stat.label,
...
export default function NonFoodFmcgTrustStatEditPage() {
  ...
  const save = async () => {
    setSaving(true);
    try {
      const body: CreateNonFoodFmcgTrustStatInput = {
      ...
      if (isNew) {
        ...
        toast.success(
          'Figure updated',
          'The public Non-Food FMCG page now shows this number.',
        );
      }
      navigate(LIST_PATH);
    } catch (error) {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this figure? The public Non-Food FMCG page will show it straight away.'
        }
