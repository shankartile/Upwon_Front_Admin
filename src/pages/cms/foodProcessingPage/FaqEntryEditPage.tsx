...
import { faqSection as faqSectionService } from '../../../services/foodProcessingPageService';
import { errorMessage } from '../../../lib/http';

import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type {
  CreateFoodProcessingFaqEntryInput as CreateFaqEntryInput,
  FoodProcessingFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/industries/food-processing/faq-section';
...
export default function FoodProcessingFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public Food Processing page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the Food Processing page."
        actions={
          <Button
            variant="secondary"
