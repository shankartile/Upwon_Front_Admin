...
import { ctaSection as service } from '../../../services/foodProcessingPageService';
...
import type { FoodProcessingCtaSection, UpsertFoodProcessingCtaSectionInput } from '../../../types/foodProcessingPage';

/**
 * The Food Processing page's closing band.
 *
 ...
 *
 * The desktop artwork keeps the copy over its empty left panel. The phone crop
...
const IMAGE_ENTITY_TYPE = 'food_processing_cta_image';

/**
 * Field rules, mirroring the server-side foodProcessing closing band validator.
 *
...
const toForm = (section: FoodProcessingCtaSection): Form => ({
...
export default function FoodProcessingCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'foodProcessingCtaDesktop' : 'foodProcessingCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertFoodProcessingCtaSectionInput = {
        ...(desktopImageFileId
      ...
      setSubmitted(false);
      toast.success('Closing band saved', 'The public Food Processing page now shows this content.');
    } catch (error) {
  ...
  return (
    <>
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.foodProcessingCtaDesktop.hint}
              >
                <ArtworkPicker
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.foodProcessingCtaMobile.hint}
              >
                <ArtworkPicker
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public Food Processing page will show the new content straight away.'
