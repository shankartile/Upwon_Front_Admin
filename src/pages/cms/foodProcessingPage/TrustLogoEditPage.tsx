...
import type { CreateFoodProcessingTrustLogoInput, FoodProcessingTrustLogo } from '../../../types/foodProcessingPage';
...
const LOGO_ENTITY_TYPE = 'food_processing_trust_logo';
...
const toForm = (logo: FoodProcessingTrustLogo): Form => ({
  alt: logo.alt,
  status: logo.status,
...
export default function FoodProcessingTrustLogoEditPage() {
  ...
  const [logo, setLogo] = useState<FoodProcessingTrustLogo | null>(null);
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreateFoodProcessingTrustLogoInput = {
      ...
      if (isNew) {
        ...
        toast.success(
          'Logo updated',
          'The public Food Processing page now shows this wall.',
        );
      }
      navigate(LIST_PATH);
    } catch (error) {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this logo? The public Food Processing page will show it straight away.'
        }
