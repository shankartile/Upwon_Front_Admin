...
const EDIT_PATH = '/cms/industries/food-processing/faq-section';

/** MAX_FOOD_PROCESSING_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function FoodProcessingFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the Food Processing page FAQ.'
