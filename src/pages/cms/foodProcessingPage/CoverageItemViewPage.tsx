...
import type { FoodProcessingCoverageItem } from '../../../types/foodProcessingPage';
 ...
 * as the grid draws it - the illustration whole, above its name.
 */
...
export default function FoodProcessingCoverageItemViewPage() {
