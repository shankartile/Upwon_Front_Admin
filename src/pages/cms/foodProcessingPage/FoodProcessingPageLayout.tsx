...
export const FOOD_PROCESSING_PAGE_BASE = '/cms/industries/food-processing';

export default function FoodProcessingPageLayout() {
  ...
  return (
    <>
      <PageHeader
        title="Food Processing Page"
        description="Content for the public UpWon Food Processing industry page, section by section."
      />
      <Tabs
        tabs={SECTIONS.map((s) => ({ id: s.id, label: s.label }))}
        active={active}
        onChange={(id) => navigate(`${FOOD_PROCESSING_PAGE_BASE}/${id}`)}
      />
      <div className="mt-5">
        <Outlet />
      </div>
