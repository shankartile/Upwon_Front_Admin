...
import { SWEETS_LIMITS, type SweetsTrustLogo } from '../../../types/sweetsPage';

/**
 * The customer logos in the trust section - the scrolling marquee under
 * "Trusted by sweet & namkeen businesses across India".
 *
...
const EDIT_PATH = '/cms/industries/sweets-namkeen/trust-section/logos';

/** MAX_SWEETS_TRUST_LOGOS on the server. Shown as a hint before the 409 fires. */
const MAX_LOGOS = SWEETS_LIMITS.trustLogos;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: SweetsTrustLogo }
  | { kind: 'status'; record: SweetsTrustLogo; next: ContentStatus };

export default function TrustLogosCard() {
  const [logos, setLogos] = useState<SweetsTrustLogo[]>([]);
