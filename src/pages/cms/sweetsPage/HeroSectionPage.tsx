...
import type { SweetsHeroSlide } from '../../../types/sweetsPage';

/**
 * Sweets hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/industries/sweets-namkeen/hero-section';

/** MAX_SWEETS_HERO_SLIDES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = 12;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: SweetsHeroSlide }
  | { kind: 'status'; record: SweetsHeroSlide; next: ContentStatus };

export default function SweetsHeroSectionPage() {
  const [entries, setEntries] = useState<SweetsHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the Sweets & Namkeen page slider.'
