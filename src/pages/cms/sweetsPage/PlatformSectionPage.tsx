...
import { SWEETS_LIMITS, type SweetsPlatformTile } from '../../../types/sweetsPage';

/**
 * The connected platform - "One Connected Platform for Every Sweets & Namkeen
 * Operation."
 *
...
const EDIT_PATH = '/cms/industries/sweets-namkeen/platform-section';

/** MAX_SWEETS_PLATFORM_TILES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = SWEETS_LIMITS.platformTiles;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: SweetsPlatformTile }
  | { kind: 'status'; record: SweetsPlatformTile; next: ContentStatus };

export default function SweetsPlatformSectionPage() {
  const [entries, setEntries] = useState<SweetsPlatformTile[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This tile will start appearing in the Sweets & Namkeen page grid.'
