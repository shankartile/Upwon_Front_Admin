...
import type {
  CreateSweetsFaqEntryInput as CreateFaqEntryInput,
  SweetsFaqEntry as FaqEntry,
...
export default function SweetsFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public Sweets & Namkeen page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the Sweets & Namkeen page."
        actions={
          <Button
            variant="secondary"
