...
const EDIT_PATH = '/cms/industries/sweets-namkeen/faq-section';

/** MAX_SWEETS_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function SweetsFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the Sweets & Namkeen page FAQ.'
