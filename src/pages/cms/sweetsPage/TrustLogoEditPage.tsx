...
import type { CreateSweetsTrustLogoInput, SweetsTrustLogo } from '../../../types/sweetsPage';
...
const LOGO_ENTITY_TYPE = 'sweets_trust_logo';
...
const toForm = (logo: SweetsTrustLogo): Form => ({
  alt: logo.alt,
  status: logo.status,
...
export default function SweetsTrustLogoEditPage() {
  ...
  const [logo, setLogo] = useState<SweetsTrustLogo | null>(null);
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreateSweetsTrustLogoInput = {
      ...
      if (isNew) {
        ...
        toast.success(
          'Logo updated',
          'The public Sweets & Namkeen page now shows this wall.',
        );
      }
      navigate(LIST_PATH);
    } catch (error) {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this logo? The public Sweets & Namkeen page will show it straight away.'
        }
