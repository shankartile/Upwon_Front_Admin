...
import type { CreateBeverageTrustLogoInput, BeverageTrustLogo } from '../../../types/beveragePage';
...
const LOGO_ENTITY_TYPE = 'beverage_trust_logo';
...
const toForm = (logo: BeverageTrustLogo): Form => ({
  alt: logo.alt,
  status: logo.status,
...
export default function BeverageTrustLogoEditPage() {
  ...
  const [logo, setLogo] = useState<BeverageTrustLogo | null>(null);
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreateBeverageTrustLogoInput = {
      ...
      if (isNew) {
        ...
        toast.success('Logo updated', 'The public Beverages & Juices page now shows this marquee.');
      }
      navigate(LIST_PATH);
    } catch (error) {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this logo? The public Beverages & Juices page will show it straight away.'
        }
