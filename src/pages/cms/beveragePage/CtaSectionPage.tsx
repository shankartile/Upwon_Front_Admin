...
import { ctaSection as service } from '../../../services/beveragePageService';
...
const IMAGE_ENTITY_TYPE = 'beverage_cta_image';

/**
 * Field rules, mirroring the server-side Beverage closing band validator.
 *
...
const toForm = (section: BeverageCtaSection): Form => ({
...
export default function BeverageCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'beverageCtaDesktop' : 'beverageCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertBeverageCtaSectionInput = {
        ...(desktopImageFileId
      ...
      toast.success('Closing band saved', 'The public Beverages & Juices page now shows this content.');
    } catch (error) {
    ...
    <>
      <SectionCopyCard
        ...
        placeholders={{
          ...
          subtext:
            'Connect procurement, ingredients, recipes, production, quality, packaging, inventory, warehouses, sales, distribution, and business operations through one platform…',
        }}
      />
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.beverageCtaDesktop.hint}
              >
                <ArtworkPicker
                  aspect="aspect-[2111/745]"
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.beverageCtaMobile.hint}
              >
                <ArtworkPicker
                  aspect="aspect-[848/1854]"
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public Beverages & Juices page will show the new content straight away.'
