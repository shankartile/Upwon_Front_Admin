...
import type {
  CreateBeverageFaqEntryInput as CreateFaqEntryInput,
  BeverageFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/industries/beverage/faq-section';
...
export default function BeverageFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public Beverages & Juices page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the Beverages & Juices page."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Textarea
                ...
                placeholder="Can UpWon help manage ingredients, recipes, and production workflows?"
            ...
            >
              <Textarea
                ...
                placeholder="Yes. Ingredient availability, recipe requirements and production activity run through one system…"
