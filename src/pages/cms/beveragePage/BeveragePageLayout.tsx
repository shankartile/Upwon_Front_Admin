 ...
 *
 * Same arrangement as the Engineering & Manufacturing page's screen: the
...
const BASE = '/cms/industries/beverage';

export default function BeveragePageLayout() {
  ...
  return (
    <>
      <PageHeader
        title="Beverages & Juices Page"
        description="Content for the public Beverages & Juices industry page, section by section."
      />
      <Tabs
