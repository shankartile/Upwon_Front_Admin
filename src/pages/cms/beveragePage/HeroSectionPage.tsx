...
import type { BeverageHeroSlide } from '../../../types/beveragePage';

/**
 * Beverage hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/industries/beverage/hero-section';

/** MAX_BEVERAGE_HERO_SLIDES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = 12;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: BeverageHeroSlide }
  | { kind: 'status'; record: BeverageHeroSlide; next: ContentStatus };

export default function BeverageHeroSectionPage() {
  const [entries, setEntries] = useState<BeverageHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the Beverages & Juices page slider.'
