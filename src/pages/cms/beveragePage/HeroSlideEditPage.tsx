...
import { heroSection } from '../../../services/beveragePageService';
...
import type { CreateBeverageHeroSlideInput, BeverageHeroSlide } from '../../../types/beveragePage';

/**
 * Create / edit one Beverage hero slide, as a full page.
 *
...
const LIST_PATH = '/cms/industries/beverage/hero-section';

/** The entity type these uploads are tagged with, to make them publicly servable. */
const IMAGE_ENTITY_TYPE = 'beverage_hero_slide';
...
const toForm = (slide: BeverageHeroSlide): Form => ({
...
export default function BeverageHeroSlideEditPage() {
  ...
  const [slide, setSlide] = useState<BeverageHeroSlide | null>(null);
  ...
  if (loadError) {
    return (
      <>
        <PageHeader title="Beverage hero slide" description="Could not load this slide." />
        <Card>
          <CardBody>
  ...
  const pickImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('beverageHero', dimensions);
    if (problem) {
  ...
  const pickMobileImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('beverageHeroMobile', dimensions);
    if (problem) {
  ...
  const save = async () => {
    ...
    try {
      ...
      const body: CreateBeverageHeroSlideInput = {
      ...
      if (isNew) {
        ...
        toast.success('Slide updated', 'The public Beverages & Juices page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One slide of the Beverages & Juices page slider."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Textarea
                ...
                placeholder="Every Ingredient, Every Batch — Every Bottle Movement Connected."
            ...
            >
              <Textarea
                ...
                placeholder="Connect procurement, ingredients, recipes, production and distribution through one platform."
            ...
            >
              <Input
                ...
                placeholder="Trusted by growing beverage and juice businesses."
          ...
          <CardBody className="space-y-4">
            ...
            <Field label={RULES.secondaryCtaLabel.label} error={errorFor('secondaryCtaLabel')}>
              <Input
                ...
                placeholder="Explore UpWon for Beverages & Juices"
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                label={HERO_IMAGE_SPECS.beverageHero.label}
                error={form.imageError ?? undefined}
                hint={HERO_IMAGE_SPECS.beverageHero.hint}
              >
                <ImagePicker
              ...
              <Field
                label={HERO_IMAGE_SPECS.beverageHeroMobile.label}
                error={form.mobileImageError ?? undefined}
                hint={HERO_IMAGE_SPECS.beverageHeroMobile.hint}
              >
                <ImagePicker
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this slide? The public Beverages & Juices page will show the new content straight away.'
        }
