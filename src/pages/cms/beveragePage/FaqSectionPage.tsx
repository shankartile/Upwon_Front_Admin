...
import { faqSection as faqSectionService } from '../../../services/beveragePageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { BeverageFaqEntry as FaqEntry } from '../../../types/beveragePage';

/**
 * Beverages & Juices FAQ admin - the question list.
 *
...
const EDIT_PATH = '/cms/industries/beverage/faq-section';

/** MAX_BEVERAGE_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function BeverageFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the Beverages & Juices page FAQ.'
