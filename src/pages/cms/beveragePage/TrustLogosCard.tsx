...
import type { BeverageTrustLogo } from '../../../types/beveragePage';

/**
 * The client logos - the marquee that scrolls under the figure cards.
 *
...
const EDIT_PATH = '/cms/industries/beverage/trust-section/logos';

/** MAX_BEVERAGE_TRUST_LOGOS on the server. Shown as a hint before the 409 fires. */
const MAX_LOGOS = 24;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: BeverageTrustLogo }
  | { kind: 'status'; record: BeverageTrustLogo; next: ContentStatus };

export default function TrustLogosCard() {
  const [logos, setLogos] = useState<BeverageTrustLogo[]>([]);
      ...
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-charcoal-light dark:text-navy-300">
            The marquee under the cards. It scrolls, so the order is the order it starts in.
          </p>
        </div>
        <Button
          variant="orange"
