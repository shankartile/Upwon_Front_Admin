...
const EDIT_PATH = '/cms/industries/beverage/platform-section/workflows';

/** MAX_BEVERAGE_PLATFORM_WORKFLOWS on the server. Shown as a hint before the 409 fires. */
const MAX_STATS = 20;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: BeveragePlatformWorkflow }
  | { kind: 'status'; record: BeveragePlatformWorkflow; next: ContentStatus };

export default function PlatformWorkflowsCard() {
  const [workflows, setWorkflows] = useState<BeveragePlatformWorkflow[]>([]);
  ...
  return (
    <section className="mt-8">
      ...
      <DataTable<BeveragePlatformWorkflow>
        data={workflows}
        loading={loading}
