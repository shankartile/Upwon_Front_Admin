...
import { heroSection } from '../../../services/qsrFranchisePageService';
...
import type { CreateQsrFranchiseHeroSlideInput, QsrFranchiseHeroSlide } from '../../../types/qsrFranchisePage';

/**
 * Create / edit one QSR & Franchise hero slide, as a full page.
 *
...
const LIST_PATH = '/cms/industries/qsr-franchise/hero-section';

/** The entity type these uploads are tagged with, to make them publicly servable. */
const IMAGE_ENTITY_TYPE = 'qsr_franchise_hero_slide';
...
const toForm = (slide: QsrFranchiseHeroSlide): Form => ({
...
export default function QsrFranchiseHeroSlideEditPage() {
  ...
  const [slide, setSlide] = useState<QsrFranchiseHeroSlide | null>(null);
  ...
  if (loadError) {
    return (
      <>
        <PageHeader title="QSR & Franchise hero slide" description="Could not load this slide." />
        <Card>
          <CardBody>
  ...
  const pickImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('qsrFranchiseHero', dimensions);
    if (problem) {
  ...
  const pickMobileImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('qsrFranchiseHeroMobile', dimensions);
    if (problem) {
  ...
  const save = async () => {
    ...
    try {
      ...
      const body: CreateQsrFranchiseHeroSlideInput = {
      ...
      if (isNew) {
        ...
        toast.success('Slide updated', 'The public QSR & Franchise F&B page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One slide of the QSR & Franchise F&B page slider."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Textarea
                ...
                placeholder="Every Recipe, Every Outlet — Every Operational Movement Connected."
            ...
            >
              <Textarea
                ...
                placeholder="Connect central kitchens, recipes, inventory, outlets and franchise partners through one platform."
            ...
            >
              <Input
                ...
                placeholder="Trusted by growing QSR and franchise food brands."
          ...
          <CardBody className="space-y-4">
            ...
            <Field label={RULES.secondaryCtaLabel.label} error={errorFor('secondaryCtaLabel')}>
              <Input
                ...
                placeholder="Explore UpWon for QSR & Franchise F&B"
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                label={HERO_IMAGE_SPECS.qsrFranchiseHero.label}
                error={form.imageError ?? undefined}
                hint={HERO_IMAGE_SPECS.qsrFranchiseHero.hint}
              >
                <ImagePicker
              ...
              <Field
                label={HERO_IMAGE_SPECS.qsrFranchiseHeroMobile.label}
                error={form.mobileImageError ?? undefined}
                hint={HERO_IMAGE_SPECS.qsrFranchiseHeroMobile.hint}
              >
                <ImagePicker
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this slide? The public QSR & Franchise F&B page will show the new content straight away.'
        }
