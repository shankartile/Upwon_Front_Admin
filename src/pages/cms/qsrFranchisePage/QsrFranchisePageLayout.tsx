 ...
 *
 * Same arrangement as the other industry pages' screens: the marketing page is
...
const BASE = '/cms/industries/qsr-franchise';

export default function QsrFranchisePageLayout() {
  ...
  return (
    <>
      <PageHeader
        title="QSR & Franchise F&B Page"
        description="Content for the public QSR & Franchise F&B industry page, section by section."
      />
      <Tabs
