...
import { ctaSection as service } from '../../../services/qsrFranchisePageService';
...
/**
 * The QSR & Franchise F&B page's closing band.
 *
...
const IMAGE_ENTITY_TYPE = 'qsr_franchise_cta_image';

/**
 * Field rules, mirroring the server-side QSR & Franchise closing band validator.
 *
...
const toForm = (section: QsrFranchiseCtaSection): Form => ({
...
export default function QsrFranchiseCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'qsrFranchiseCtaDesktop' : 'qsrFranchiseCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertQsrFranchiseCtaSectionInput = {
        ...(desktopImageFileId
      ...
      toast.success('Closing band saved', 'The public QSR & Franchise F&B page now shows this content.');
    } catch (error) {
    ...
    <>
      <SectionCopyCard
        ...
        placeholders={{
          ...
          subtext:
            'Connect procurement, central kitchens, recipes, production, inventory, outlets, franchise operations, people, sales…',
        }}
      />
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.qsrFranchiseCtaDesktop.hint}
              >
                <ArtworkPicker
                  aspect="aspect-[2151/731]"
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.qsrFranchiseCtaMobile.hint}
              >
                <ArtworkPicker
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public QSR & Franchise F&B page will show the new content straight away.'
