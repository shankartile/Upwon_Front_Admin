...
import { faqSection as faqSectionService } from '../../../services/qsrFranchisePageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { QsrFranchiseFaqEntry as FaqEntry } from '../../../types/qsrFranchisePage';

/**
 * QSR & Franchise F&B FAQ admin - the question list.
 *
...
const EDIT_PATH = '/cms/industries/qsr-franchise/faq-section';

/** MAX_QSR_FRANCHISE_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function QsrFranchiseFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the QSR & Franchise F&B page FAQ.'
