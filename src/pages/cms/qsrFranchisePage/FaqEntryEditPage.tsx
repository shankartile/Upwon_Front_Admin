...
import type {
  CreateQsrFranchiseFaqEntryInput as CreateFaqEntryInput,
  QsrFranchiseFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/industries/qsr-franchise/faq-section';
...
export default function QsrFranchiseFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public QSR & Franchise F&B page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the QSR & Franchise F&B page."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Textarea
                ...
                placeholder="Can UpWon help manage central kitchens and multiple outlets?"
            ...
            >
              <Textarea
                ...
                placeholder="Yes. Central production, inventory and outlet requirements run through connected workflows…"
