...
import type { QsrFranchiseTrustLogo } from '../../../types/qsrFranchisePage';
...
const EDIT_PATH = '/cms/industries/qsr-franchise/trust-section/logos';

/** MAX_QSR_FRANCHISE_TRUST_LOGOS on the server. Shown as a hint before the 409 fires. */
const MAX_LOGOS = 24;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: QsrFranchiseTrustLogo }
  | { kind: 'status'; record: QsrFranchiseTrustLogo; next: ContentStatus };

export default function TrustLogosCard() {
  const [logos, setLogos] = useState<QsrFranchiseTrustLogo[]>([]);
  ...
  return (
    <section className="mt-8">
      ...
      <DataTable<QsrFranchiseTrustLogo>
        data={logos}
        loading={loading}
