...
const LIST_PATH = '/cms/industries/qsr-franchise/platform-section';
...
const toForm = (workflow: QsrFranchisePlatformWorkflow): Form => ({
...
export default function QsrFranchisePlatformWorkflowEditPage() {
  ...
  const [workflow, setWorkflow] = useState<QsrFranchisePlatformWorkflow | null>(null);
  ...
  const save = async () => {
    setSaving(true);
    try {
      const body: CreateQsrFranchisePlatformWorkflowInput = {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this workflow? The public QSR & Franchise F&B page will show it straight away.'
        }
