...
import type { CreateQsrFranchiseTrustLogoInput, QsrFranchiseTrustLogo } from '../../../types/qsrFranchisePage';
...
const LOGO_ENTITY_TYPE = 'qsr_franchise_trust_logo';
...
const toForm = (logo: QsrFranchiseTrustLogo): Form => ({
  alt: logo.alt,
  status: logo.status,
...
export default function QsrFranchiseTrustLogoEditPage() {
  ...
  const [logo, setLogo] = useState<QsrFranchiseTrustLogo | null>(null);
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreateQsrFranchiseTrustLogoInput = {
      ...
      if (isNew) {
        ...
        toast.success('Logo updated', 'The public QSR & Franchise F&B page now shows this marquee.');
      }
      navigate(LIST_PATH);
    } catch (error) {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this logo? The public QSR & Franchise F&B page will show it straight away.'
        }
