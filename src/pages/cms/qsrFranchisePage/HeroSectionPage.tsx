...
import type { QsrFranchiseHeroSlide } from '../../../types/qsrFranchisePage';

/**
 * QSR & Franchise hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/industries/qsr-franchise/hero-section';

/** MAX_QSR_FRANCHISE_HERO_SLIDES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = 12;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: QsrFranchiseHeroSlide }
  | { kind: 'status'; record: QsrFranchiseHeroSlide; next: ContentStatus };

export default function QsrFranchiseHeroSectionPage() {
  const [entries, setEntries] = useState<QsrFranchiseHeroSlide[]>([]);
  ...
  return (
    <>
      ...
      <DataTable<QsrFranchiseHeroSlide>
        data={entries}
        loading={loading}
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the QSR & Franchise F&B page slider.'
