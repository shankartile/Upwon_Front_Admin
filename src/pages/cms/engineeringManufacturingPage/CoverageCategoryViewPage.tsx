...
/**
 * One business type from the industry coverage grid, read-only.
 *
...
export default function EngineeringCoverageCategoryViewPage() {
  ...
  return (
    <>
      <PageHeader
        ...
        title="View business type"
        description="Read-only. Use Edit to change this business type."
        actions={
          <>
            <Button
              variant="secondary"
