...
import type {
  CreateEngineeringFaqEntryInput as CreateFaqEntryInput,
  EngineeringFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/industries/engineering-manufacturing/faq-section';
...
export default function EngineeringFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public Engineering & Manufacturing page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the Engineering & Manufacturing page."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Textarea
                ...
                placeholder="Can UpWon help manage production planning and scheduling?"
            ...
            >
              <Textarea
                ...
                placeholder="Yes. Production requirements, material availability and work progress run through one system…"
