...
import type { CreateEngineeringTrustLogoInput, EngineeringTrustLogo } from '../../../types/engineeringManufacturingPage';
...
const LOGO_ENTITY_TYPE = 'engineering_trust_logo';
...
const toForm = (logo: EngineeringTrustLogo): Form => ({
  alt: logo.alt,
  status: logo.status,
...
export default function EngineeringTrustLogoEditPage() {
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreateEngineeringTrustLogoInput = {
      ...
      if (isNew) {
        ...
        toast.success('Logo updated', 'The public Engineering & Manufacturing page now shows this marquee.');
      }
      navigate(LIST_PATH);
    } catch (error) {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this logo? The public Engineering & Manufacturing page will show it straight away.'
        }
