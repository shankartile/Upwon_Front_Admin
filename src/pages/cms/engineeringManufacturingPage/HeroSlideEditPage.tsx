...
import { heroSection } from '../../../services/engineeringManufacturingPageService';
...
import type { CreateEngineeringHeroSlideInput, EngineeringHeroSlide } from '../../../types/engineeringManufacturingPage';

/**
 * Create / edit one Engineering hero slide, as a full page.
 *
...
const LIST_PATH = '/cms/industries/engineering-manufacturing/hero-section';

/** The entity type these uploads are tagged with, to make them publicly servable. */
const IMAGE_ENTITY_TYPE = 'engineering_hero_slide';
...
const toForm = (slide: EngineeringHeroSlide): Form => ({
...
export default function EngineeringHeroSlideEditPage() {
  ...
  const [slide, setSlide] = useState<EngineeringHeroSlide | null>(null);
  ...
  if (loadError) {
    return (
      <>
        <PageHeader title="Engineering hero slide" description="Could not load this slide." />
        <Card>
          <CardBody>
  ...
  const pickImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('engineeringHero', dimensions);
    if (problem) {
  ...
  const pickMobileImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('engineeringHeroMobile', dimensions);
    if (problem) {
  ...
  const save = async () => {
    ...
    try {
      ...
      const body: CreateEngineeringHeroSlideInput = {
      ...
      if (isNew) {
        ...
        toast.success('Slide updated', 'The public Engineering & Manufacturing page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One slide of the Engineering & Manufacturing page slider."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Input
                ...
                placeholder="ENGINEERING & MANUFACTURING"
            ...
            >
              <Textarea
                ...
                placeholder="Every Material, Every Process — Every Production Movement Connected."
            ...
            >
              <Textarea
                ...
                placeholder="Connect procurement, production, quality and dispatch through one platform."
            ...
            >
              <Input
                ...
                placeholder="Trusted by growing engineering and manufacturing businesses."
          ...
          <CardBody className="space-y-4">
            ...
            <Field label={RULES.secondaryCtaLabel.label} error={errorFor('secondaryCtaLabel')}>
              <Input
                ...
                placeholder="Explore UpWon for Engineering & Manufacturing"
            ...
            <Field
              ...
              hint="A route like /what-is-upwon, or a full https:// URL."
            >
              <Input
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                label={HERO_IMAGE_SPECS.engineeringHero.label}
                error={form.imageError ?? undefined}
                hint={HERO_IMAGE_SPECS.engineeringHero.hint}
              >
                <ImagePicker
              ...
              <Field
                label={HERO_IMAGE_SPECS.engineeringHeroMobile.label}
                error={form.mobileImageError ?? undefined}
                hint={HERO_IMAGE_SPECS.engineeringHeroMobile.hint}
              >
                <ImagePicker
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this slide? The public Engineering & Manufacturing page will show the new content straight away.'
        }
