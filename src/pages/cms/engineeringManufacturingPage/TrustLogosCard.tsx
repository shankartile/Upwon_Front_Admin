...
const EDIT_PATH = '/cms/industries/engineering-manufacturing/trust-section/logos';

/** MAX_ENGINEERING_TRUST_LOGOS on the server. Shown as a hint before the 409 fires. */
const MAX_LOGOS = 24;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: EngineeringTrustLogo }
  | { kind: 'status'; record: EngineeringTrustLogo; next: ContentStatus };

export default function TrustLogosCard() {
  const [logos, setLogos] = useState<EngineeringTrustLogo[]>([]);
  ...
  return (
    <section className="mt-8">
      ...
      <DataTable<EngineeringTrustLogo>
        data={logos}
        loading={loading}
