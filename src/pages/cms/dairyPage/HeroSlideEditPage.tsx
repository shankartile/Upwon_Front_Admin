...
import type { CreateDairyHeroSlideInput, DairyHeroSlide } from '../../../types/dairyPage';

/**
 * Create / edit one Dairy & Ice Cream hero slide, as a full page.
 *
...
const IMAGE_ENTITY_TYPE = 'dairy_hero_slide';
...
const toForm = (slide: DairyHeroSlide): Form => ({
...
export default function DairyHeroSlideEditPage() {
  ...
  const pickImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('dairyHero', dimensions);
    if (problem) {
  ...
  const pickMobileImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('dairyHeroMobile', dimensions);
    if (problem) {
  ...
  const save = async () => {
    ...
    try {
      ...
      const body: CreateDairyHeroSlideInput = {
      ...
      if (isNew) {
        ...
        toast.success('Slide updated', 'The public Dairy & Ice Cream page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One slide of the Dairy & Ice Cream page slider."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Textarea
                ...
                placeholder="Produce Fresh, Move Faster — Manage Everything in One Flow."
            ...
            >
              <Input
                ...
                placeholder="Integrated ERP managing 50+ dairy and ice cream brands."
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                label={HERO_IMAGE_SPECS.dairyHero.label}
                error={form.imageError ?? undefined}
                hint={HERO_IMAGE_SPECS.dairyHero.hint}
              >
                <ImagePicker
              ...
              <Field
                label={HERO_IMAGE_SPECS.dairyHeroMobile.label}
                error={form.mobileImageError ?? undefined}
                hint={HERO_IMAGE_SPECS.dairyHeroMobile.hint}
              >
                <ImagePicker
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this slide? The public Dairy & Ice Cream page will show the new content straight away.'
        }
