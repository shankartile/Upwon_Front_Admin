...
/**
 * Dairy & Ice Cream hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/industries/dairy/hero-section';

/** MAX_DAIRY_HERO_SLIDES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = 12;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: DairyHeroSlide }
  | { kind: 'status'; record: DairyHeroSlide; next: ContentStatus };

export default function DairyHeroSectionPage() {
  const [entries, setEntries] = useState<DairyHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the Dairy & Ice Cream page slider.'
