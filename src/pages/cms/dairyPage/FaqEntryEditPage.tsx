...
import type {
  CreateDairyFaqEntryInput as CreateFaqEntryInput,
  DairyFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/industries/dairy/faq-section';
...
export default function DairyFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public Dairy & Ice Cream page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the Dairy & Ice Cream page."
        actions={
          <Button
            variant="secondary"
