...
import { DAIRY_LIMITS, type DairyTrustLogo } from '../../../types/dairyPage';

/**
 * The customer logos in the trust section - the scrolling marquee under
 * "Trusted by dairy and ice cream businesses across India".
 *
...
const EDIT_PATH = '/cms/industries/dairy/trust-section/logos';

/** MAX_DAIRY_TRUST_LOGOS on the server. Shown as a hint before the 409 fires. */
const MAX_LOGOS = DAIRY_LIMITS.trustLogos;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: DairyTrustLogo }
  | { kind: 'status'; record: DairyTrustLogo; next: ContentStatus };

export default function TrustLogosCard() {
  const [logos, setLogos] = useState<DairyTrustLogo[]>([]);
