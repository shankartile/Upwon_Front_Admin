...
import type { DairyTrustLogo } from '../../../types/dairyPage';
 ...
 * the wall draws it, against the white ground it sits on.
 */
...
export default function DairyTrustLogoViewPage() {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr,360px]">
        <Card>
          <CardHeader title="The mark" subtitle="As the wall draws it, on white." />
          <CardBody>
              ...
              {logo.image ? (
                ...
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm italic text-charcoal-light dark:text-navy-300">
                    The image this logo pointed at is gone, so it is left out of the wall.
                  </p>
                </div>
              )}
            </div>
