...
import { ctaSection as service } from '../../../services/dairyPageService';
...
import type { DairyCtaSection, UpsertDairyCtaSectionInput } from '../../../types/dairyPage';
...
const IMAGE_ENTITY_TYPE = 'dairy_cta_image';

/**
 * Field rules, mirroring the server-side dairy closing band validator.
 *
...
const toForm = (section: DairyCtaSection): Form => ({
...
export default function DairyCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'dairyCtaDesktop' : 'dairyCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertDairyCtaSectionInput = {
        ...(desktopImageFileId
      ...
      setSubmitted(false);
      toast.success('Closing band saved', 'The public Dairy & Ice Cream page now shows this content.');
    } catch (error) {
  ...
  return (
    <>
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.dairyCtaDesktop.hint}
              >
                <ArtworkPicker
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.dairyCtaMobile.hint}
              >
                <ArtworkPicker
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public Dairy & Ice Cream page will show the new content straight away.'
