...
import { faqSection as faqSectionService } from '../../../services/dairyPageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { DairyFaqEntry as FaqEntry } from '../../../types/dairyPage';
...
const EDIT_PATH = '/cms/industries/dairy/faq-section';

/** MAX_DAIRY_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function DairyFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the Dairy & Ice Cream page FAQ.'
