...
import { ctaSection as service } from '../../../services/spicesAgroPageService';
...
/**
 * The Spices & Agro Processing page's closing band.
 *
 ...
 * band's form without its footnote and handwritten note, as on the Engineering page.
 *
...
const IMAGE_ENTITY_TYPE = 'spices_agro_cta_image';

/**
 * Field rules, mirroring the server-side Spices & Agro closing band validator.
 *
...
const toForm = (section: SpicesAgroCtaSection): Form => ({
...
export default function SpicesAgroCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'spicesAgroCtaDesktop' : 'spicesAgroCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertSpicesAgroCtaSectionInput = {
        ...(desktopImageFileId
      ...
      toast.success('Closing band saved', 'The public Spices & Agro Processing page now shows this content.');
    } catch (error) {
    ...
    <>
      <SectionCopyCard
        ...
        placeholders={{
          ...
          subtext:
            'Connect procurement, raw materials, quality, processing, production, inventory, warehouses, sales, distribution, and business operations through one platform…',
        }}
      />
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.spicesAgroCtaDesktop.hint}
              >
                <ArtworkPicker
                  aspect="aspect-[1600/570]"
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.spicesAgroCtaMobile.hint}
              >
                <ArtworkPicker
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public Spices & Agro Processing page will show the new content straight away.'
