...
import type {
  CreateSpicesAgroFaqEntryInput as CreateFaqEntryInput,
  SpicesAgroFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/industries/spices-agro/faq-section';
...
export default function SpicesAgroFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public Spices & Agro Processing page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the Spices & Agro Processing page."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Textarea
                ...
                placeholder="Can UpWon help manage raw materials and production workflows?"
            ...
            >
              <Textarea
                ...
                placeholder="Yes. Procurement, raw-material availability and processing activity run through one system…"
