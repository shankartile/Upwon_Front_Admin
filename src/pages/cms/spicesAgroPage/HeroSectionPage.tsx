...
import type { SpicesAgroHeroSlide } from '../../../types/spicesAgroPage';

/**
 * Spices & Agro hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/industries/spices-agro/hero-section';

/** MAX_SPICES_AGRO_HERO_SLIDES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = 12;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: SpicesAgroHeroSlide }
  | { kind: 'status'; record: SpicesAgroHeroSlide; next: ContentStatus };

export default function SpicesAgroHeroSectionPage() {
  const [entries, setEntries] = useState<SpicesAgroHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the Spices & Agro Processing page slider.'
