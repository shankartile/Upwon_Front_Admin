...
import { heroSection } from '../../../services/spicesAgroPageService';
...
import type { CreateSpicesAgroHeroSlideInput, SpicesAgroHeroSlide } from '../../../types/spicesAgroPage';

/**
 * Create / edit one Spices & Agro hero slide, as a full page.
 *
...
const LIST_PATH = '/cms/industries/spices-agro/hero-section';

/** The entity type these uploads are tagged with, to make them publicly servable. */
const IMAGE_ENTITY_TYPE = 'spices_agro_hero_slide';
...
const toForm = (slide: SpicesAgroHeroSlide): Form => ({
...
export default function SpicesAgroHeroSlideEditPage() {
  ...
  const [slide, setSlide] = useState<SpicesAgroHeroSlide | null>(null);
  ...
  if (loadError) {
    return (
      <>
        <PageHeader title="Spices & Agro hero slide" description="Could not load this slide." />
        <Card>
          <CardBody>
  ...
  const pickImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('spicesAgroHero', dimensions);
    if (problem) {
  ...
  const pickMobileImage = async (file: File) => {
    ...
    const problem = checkHeroImageDimensions('spicesAgroHeroMobile', dimensions);
    if (problem) {
  ...
  const save = async () => {
    ...
    try {
      ...
      const body: CreateSpicesAgroHeroSlideInput = {
      ...
      if (isNew) {
        ...
        toast.success('Slide updated', 'The public Spices & Agro Processing page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One slide of the Spices & Agro Processing page slider."
        actions={
          <Button
            variant="secondary"
          ...
          <CardBody className="space-y-4">
            ...
            >
              <Input
                ...
                placeholder="SPICES & AGRO PROCESSING"
            ...
            >
              <Textarea
                ...
                placeholder="Every Raw Material, Every Batch — Every Processing Movement Connected."
            ...
            >
              <Textarea
                ...
                placeholder="Connect sourcing, raw materials, quality, production and distribution through one platform."
            ...
            >
              <Input
                ...
                placeholder="Trusted by growing spices and agro-processing businesses."
          ...
          <CardBody className="space-y-4">
            ...
            <Field label={RULES.secondaryCtaLabel.label} error={errorFor('secondaryCtaLabel')}>
              <Input
                ...
                placeholder="Explore UpWon for Spices & Agro Processing"
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                label={HERO_IMAGE_SPECS.spicesAgroHero.label}
                error={form.imageError ?? undefined}
                hint={HERO_IMAGE_SPECS.spicesAgroHero.hint}
              >
                <ImagePicker
              ...
              <Field
                label={HERO_IMAGE_SPECS.spicesAgroHeroMobile.label}
                error={form.mobileImageError ?? undefined}
                hint={HERO_IMAGE_SPECS.spicesAgroHeroMobile.hint}
              >
                <ImagePicker
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this slide? The public Spices & Agro Processing page will show the new content straight away.'
        }
