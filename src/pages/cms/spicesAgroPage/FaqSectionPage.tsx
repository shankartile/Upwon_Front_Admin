...
import { faqSection as faqSectionService } from '../../../services/spicesAgroPageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { SpicesAgroFaqEntry as FaqEntry } from '../../../types/spicesAgroPage';

/**
 * Spices & Agro Processing FAQ admin - the question list.
 *
...
const EDIT_PATH = '/cms/industries/spices-agro/faq-section';

/** MAX_SPICES_AGRO_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function SpicesAgroFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the Spices & Agro Processing page FAQ.'
