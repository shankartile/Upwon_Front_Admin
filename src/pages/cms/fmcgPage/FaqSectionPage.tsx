...
import { faqSection as faqSectionService } from '../../../services/fmcgPageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { FmcgFaqEntry as FaqEntry } from '../../../types/fmcgPage';
...
const EDIT_PATH = '/cms/industries/fmcg-distribution/faq-section';

/** MAX_FMCG_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
...
export default function FmcgFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the FMCG Distribution page FAQ.'
