...
import type { CreateFmcgTrustLogoInput, FmcgTrustLogo } from '../../../types/fmcgPage';
...
const LOGO_ENTITY_TYPE = 'fmcg_trust_logo';
...
const toForm = (logo: FmcgTrustLogo): Form => ({
  alt: logo.alt,
  status: logo.status,
...
export default function FmcgTrustLogoEditPage() {
  ...
  const [logo, setLogo] = useState<FmcgTrustLogo | null>(null);
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreateFmcgTrustLogoInput = {
      ...
      if (isNew) {
        ...
        toast.success(
          'Logo updated',
          'The public FMCG Distribution page now shows this wall.',
        );
      }
      navigate(LIST_PATH);
    } catch (error) {
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this logo? The public FMCG Distribution page will show it straight away.'
        }
