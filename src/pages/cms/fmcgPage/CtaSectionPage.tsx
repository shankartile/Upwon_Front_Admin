...
import { ctaSection as service } from '../../../services/fmcgPageService';
...
import type { FmcgCtaSection, UpsertFmcgCtaSectionInput } from '../../../types/fmcgPage';

/**
 * The FMCG Distribution page's closing band.
 *
...
const IMAGE_ENTITY_TYPE = 'fmcg_cta_image';

/**
 * Field rules, mirroring the server-side fmcg closing band validator.
 *
...
const toForm = (section: FmcgCtaSection): Form => ({
...
export default function FmcgCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'fmcgCtaDesktop' : 'fmcgCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertFmcgCtaSectionInput = {
        ...(desktopImageFileId
      ...
      setSubmitted(false);
      toast.success('Closing band saved', 'The public FMCG Distribution page now shows this content.');
    } catch (error) {
  ...
  return (
    <>
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.fmcgCtaDesktop.hint}
              >
                <ArtworkPicker
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.fmcgCtaMobile.hint}
              >
                <ArtworkPicker
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public FMCG Distribution page will show the new content straight away.'
