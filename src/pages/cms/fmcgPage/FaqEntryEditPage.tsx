...
import type {
  CreateFmcgFaqEntryInput as CreateFaqEntryInput,
  FmcgFaqEntry as FaqEntry,
} from '../../../types/fmcgPage';
...
const LIST_PATH = '/cms/industries/fmcg-distribution/faq-section';
...
export default function FmcgFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public FMCG Distribution page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the FMCG Distribution page."
        actions={
          <Button
            variant="secondary"
