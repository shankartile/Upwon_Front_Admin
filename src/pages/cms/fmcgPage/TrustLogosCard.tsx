...
import { FMCG_LIMITS, type FmcgTrustLogo } from '../../../types/fmcgPage';

/**
 * The customer logos in the trust section - the scrolling marquee under
 * "Trusted across FMCG distribution".
 *
...
const EDIT_PATH = '/cms/industries/fmcg-distribution/trust-section/logos';

/** MAX_FMCG_TRUST_LOGOS on the server. Shown as a hint before the 409 fires. */
const MAX_LOGOS = FMCG_LIMITS.trustLogos;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: FmcgTrustLogo }
  | { kind: 'status'; record: FmcgTrustLogo; next: ContentStatus };

export default function TrustLogosCard() {
  const [logos, setLogos] = useState<FmcgTrustLogo[]>([]);
