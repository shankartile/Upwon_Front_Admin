...
import type { FmcgHeroSlide } from '../../../types/fmcgPage';

/**
 * FMCG hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/industries/fmcg-distribution/hero-section';

/** MAX_FMCG_HERO_SLIDES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = 12;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: FmcgHeroSlide }
  | { kind: 'status'; record: FmcgHeroSlide; next: ContentStatus };

export default function FmcgHeroSectionPage() {
  const [entries, setEntries] = useState<FmcgHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the FMCG Distribution page slider.'
