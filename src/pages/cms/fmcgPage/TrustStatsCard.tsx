...
import { FMCG_LIMITS, type FmcgTrustStat } from '../../../types/fmcgPage';
...
const EDIT_PATH = '/cms/industries/fmcg-distribution/trust-section/stats';

/** MAX_FMCG_TRUST_STATS on the server. Shown as a hint before the 409 fires. */
const MAX_STATS = FMCG_LIMITS.trustStats;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: FmcgTrustStat }
  | { kind: 'status'; record: FmcgTrustStat; next: ContentStatus };

export default function TrustStatsCard() {
  const [stats, setStats] = useState<FmcgTrustStat[]>([]);
