...
import { FMCG_LIMITS, type FmcgPlatformTile } from '../../../types/fmcgPage';

/**
 * The connected platform - "Five Connected Solutions. One Smarter Distribution
 * Operation."
 *
...
const EDIT_PATH = '/cms/industries/fmcg-distribution/platform-section';

/** MAX_FMCG_PLATFORM_TILES on the server. Shown as a hint before the 409 fires. */
const MAX_ENTRIES = FMCG_LIMITS.platformTiles;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: FmcgPlatformTile }
  | { kind: 'status'; record: FmcgPlatformTile; next: ContentStatus };

export default function FmcgPlatformSectionPage() {
  const [entries, setEntries] = useState<FmcgPlatformTile[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This tile will start appearing in the FMCG Distribution page grid.'
