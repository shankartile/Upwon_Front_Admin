...
import type {
  CreateSfaFaqEntryInput as CreateFaqEntryInput,
  SfaFaqEntry as FaqEntry,
...
const LIST_PATH = '/cms/products/sfa-dms/faq-section';
...
export default function SfaFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public SFA-DMS page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the SFA-DMS page."
        actions={
          <Button
            variant="secondary"
