...
import type { SfaHeroSlide } from '../../../types/sfaDmsPage';

/**
 * SFA-DMS hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/products/sfa-dms/hero-section';
...
type Pending =
  | { kind: 'delete'; record: SfaHeroSlide }
  | { kind: 'status'; record: SfaHeroSlide; next: ContentStatus };

export default function SfaHeroSectionPage() {
  const [entries, setEntries] = useState<SfaHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the SFA-DMS page slider.'
