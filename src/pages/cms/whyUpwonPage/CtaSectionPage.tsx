...
import { ctaSection as service } from '../../../services/whyUpwonPageService';
...
/**
 * The Why UpWon page's closing band.
 *
...
const IMAGE_ENTITY_TYPE = 'why_upwon_cta_image';

/**
 * Field rules, mirroring the server-side Why UpWon closing band validator.
 *
...
const toForm = (section: WhyUpwonCtaSection): Form => ({
...
export default function WhyUpwonCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'whyUpwonCtaDesktop' : 'whyUpwonCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertWhyUpwonCtaSectionInput = {
        ...(desktopImageFileId
      ...
      toast.success('Closing band saved', 'The public Why UpWon page now shows this content.');
    } catch (error) {
    ...
    <>
      <SectionCopyCard
        ...
        placeholders={{
          ...
          subtext:
            'Discover how UpWon can help bring your workflows, teams, and business information together…',
        }}
      />
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.whyUpwonCtaDesktop.hint}
              >
                <ArtworkPicker
                  aspect="aspect-[2109/746]"
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.whyUpwonCtaMobile.hint}
              >
                <ArtworkPicker
                  aspect="aspect-[851/1848]"
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public Why UpWon page will show the new content straight away.'
