...
/**
 * One client logo, read-only.
 *
 * Not the edit form with its inputs disabled: a form full of greyed-out boxes
 * reads as "broken" rather than "not yours to change". This shows the mark as
 * the client wall draws it, against the white ground it sits on.
 */
...
export default function WhyUpwonClientLogoViewPage() {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr,360px]">
        <Card>
          <CardHeader title="The mark" subtitle="As the client wall draws it, on white." />
          <CardBody>
              ...
              {logo.image ? (
                ...
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm italic text-charcoal-light dark:text-navy-300">
                    The image this logo pointed at is gone, so it is left out of the client wall.
                  </p>
                </div>
              )}
            </div>
