 ...
 *
 * Same arrangement as the SFA-DMS and ERP page screens: the marketing page is
 * authored section by section and the backend is laid out the same way, so this
 * is a tab strip over those sections rather than one long form.
 *
...
const BASE = '/cms/products/fms';

export default function FmsPageLayout() {
  ...
  return (
    <>
      <PageHeader
        title="FMS Page"
        description="Content for the public UpWon FMS product page, section by section."
      />
      <Tabs
