...
const EDIT_PATH = '/cms/products/fms/outcomes-section/stories';

/** MAX_FMS_OUTCOME_STORIES on the server. Shown before the 409 fires. */
const MAX_STORIES = 8;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: FmsOutcomeStory }
  | { kind: 'status'; record: FmsOutcomeStory; next: ContentStatus };

export default function OutcomeStoriesCard() {
  const [stories, setStories] = useState<FmsOutcomeStory[]>([]);
