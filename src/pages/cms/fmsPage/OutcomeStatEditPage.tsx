...
import type { CreateFmsOutcomeStatInput, FmsOutcomeStat } from '../../../types/fmsPage';
...
const toForm = (stat: FmsOutcomeStat): Form => ({
  value: stat.value,
  label: stat.label,
  status: stat.status,
...
export default function FmsOutcomeStatEditPage() {
  ...
  const save = async () => {
    ...
    setSaving(true);
    try {
      const body: CreateFmsOutcomeStatInput = {
