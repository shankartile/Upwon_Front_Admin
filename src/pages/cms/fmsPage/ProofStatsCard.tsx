...
const EDIT_PATH = '/cms/products/fms/proof-section/stats';

/** MAX_FMS_PROOF_STATS on the server. Shown as a hint before the 409 fires. */
const MAX_STATS = 4;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: FmsProofStat }
  | { kind: 'status'; record: FmsProofStat; next: ContentStatus };

export default function ProofStatsCard() {
  const [stats, setStats] = useState<FmsProofStat[]>([]);
      ...
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-charcoal-light dark:text-navy-300">
            The two-by-two grid beside the wall. At most {MAX_STATS} — that is what it holds.
        ...
        columns={[
          ...
          },
          {
            ...
            render: (row) => (
              ...
              // grid rather than a column of grey glyphs.
              <span
