...
import { ctaSection as service } from '../../../services/fmsPageService';
...
import type { FmsCtaSection, UpsertFmsCtaSectionInput } from '../../../types/fmsPage';
...
const IMAGE_ENTITY_TYPE = 'fms_cta_image';

/**
 * Field rules, mirroring the server-side FMS closing band validator.
 *
...
const toForm = (section: FmsCtaSection): Form => ({
...
export default function FmsCtaSectionPage() {
  ...
  const pickImage = async (which: 'desktop' | 'mobile', file: File) => {
    const slot: HeroImageVariant = which === 'desktop' ? 'fmsCtaDesktop' : 'fmsCtaMobile';
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: UpsertFmsCtaSectionInput = {
        ...(desktopImageFileId
      ...
      toast.success('Closing band saved', 'The public FMS page now shows this content.');
    } catch (error) {
  ...
  return (
    <>
            ...
            <CardBody className="space-y-4">
              ...
              >
                <Input
                  ...
                  placeholder="No obligation. 30 minutes about your franchise network, not a sales pitch."
          ...
          <Card>
            ...
            <CardBody className="space-y-5">
              <Field
                ...
                hint={HERO_IMAGE_SPECS.fmsCtaDesktop.hint}
              >
                <ArtworkPicker
                  aspect="aspect-[16/6]"
              ...
              <Field
                ...
                hint={HERO_IMAGE_SPECS.fmsCtaMobile.hint}
              >
                <ArtworkPicker
                  aspect="aspect-[9/16]"
      ...
      <ConfirmDialog
        ...
        description={
          existed
            ? 'Are you sure you want to update this band? The public FMS page will show the new content straight away.'
