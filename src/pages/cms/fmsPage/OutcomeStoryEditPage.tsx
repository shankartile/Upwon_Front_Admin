...
import type { CreateFmsOutcomeStoryInput, FmsOutcomeStory } from '../../../types/fmsPage';
...
const LOGO_ENTITY_TYPE = 'fms_outcome_logo';
const PHOTO_ENTITY_TYPE = 'fms_outcome_photo';
...
const toForm = (story: FmsOutcomeStory): Form => ({
  name: story.name,
  slug: story.slug,
  quote: story.quote,
...
function validateField(name: TextFieldName, raw: string): string | null {
  ...
  // Mirrors fms_outcome_stories_slug_format_check.
...
export default function FmsOutcomeStoryEditPage() {
  ...
  const save = async () => {
    ...
    try {
       ...
       */
      const body: CreateFmsOutcomeStoryInput = {
        name: form.name.trim(),
        slug: form.slug.trim(),
      ...
      if (isNew) {
        ...
        toast.success('Story updated', 'The public FMS page now shows this card.');
        navigate(LIST_PATH);
      }
    } catch (error) {
  ...
  const logoSpec = HERO_IMAGE_SPECS.fmsOutcomeLogo;
  const photoSpec = HERO_IMAGE_SPECS.fmsOutcomePhoto;
              ...
              <FieldGrid>
                ...
                >
                  <ImagePicker
                    ...
                    fit="cover"
                    disabled={saving}
                    onPick={(file) => void pickImage('photo', 'fmsOutcomePhoto', file)}
                ...
                >
                  <ImagePicker
                    ...
                    fit="contain"
                    disabled={saving}
                    onPick={(file) => void pickImage('logo', 'fmsOutcomeLogo', file)}
      ...
      <ConfirmDialog
        ...
        description={
          isNew
            ...
            : 'Are you sure you want to update this story? The public FMS page will show it straight away.'
        }
