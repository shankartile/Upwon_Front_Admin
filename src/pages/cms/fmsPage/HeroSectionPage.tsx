...
import type { FmsHeroSlide } from '../../../types/fmsPage';

/**
 * FMS hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/products/fms/hero-section';
...
type Pending =
  | { kind: 'delete'; record: FmsHeroSlide }
  | { kind: 'status'; record: FmsHeroSlide; next: ContentStatus };

export default function FmsHeroSectionPage() {
  const [entries, setEntries] = useState<FmsHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the FMS page slider.'
