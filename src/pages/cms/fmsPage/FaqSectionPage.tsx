...
import { faqSection as faqSectionService } from '../../../services/fmsPageService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from '../homePage/SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus } from '../../../types/homePage';
import type { FmsFaqEntry as FaqEntry } from '../../../types/fmsPage';
...
const EDIT_PATH = '/cms/products/fms/faq-section';
...
export default function FmsFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the FMS page FAQ.'
