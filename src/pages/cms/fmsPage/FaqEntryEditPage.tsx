...
import type {
  CreateFmsFaqEntryInput as CreateFaqEntryInput,
  FmsFaqEntry as FaqEntry,
} from '../../../types/fmsPage';
...
const LIST_PATH = '/cms/products/fms/faq-section';
...
export default function FmsFaqEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Question updated', 'The public FMS page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One question of the FAQ accordion on the FMS page."
        actions={
          <Button
            variant="secondary"
