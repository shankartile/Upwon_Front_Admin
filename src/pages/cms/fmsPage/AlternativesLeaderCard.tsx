...
export default function AlternativesLeaderCard() {
  ...
  const save = async () => {
    ...
    try {
      ...
      toast.success('Leader column saved', 'The public FMS page now shows it.');
      await load();
    } catch (error) {
  ...
  return (
    <section className="mt-8">
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to save this? The public FMS page will show it straight away."
        confirmLabel="Save"
        variant="primary"
      />
    </section>
