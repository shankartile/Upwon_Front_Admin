...
const EDIT_PATH = '/cms/products/fms/proof-section/logos';

/** MAX_FMS_PROOF_LOGOS on the server. Shown as a hint before the 409 fires. */
const MAX_LOGOS = 24;

type StatusFilter = 'all' | ContentStatus;

type Pending =
  | { kind: 'delete'; record: FmsProofLogo }
  | { kind: 'status'; record: FmsProofLogo; next: ContentStatus };

export default function ProofLogosCard() {
  const [logos, setLogos] = useState<FmsProofLogo[]>([]);
