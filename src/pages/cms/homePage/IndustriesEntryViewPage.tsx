...
import { STATUS_LABELS, type IndustriesEntry } from '../../../types/homePage';

/**
 * One industries entry, read-only.
 *
...
export default function IndustriesEntryViewPage() {
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr,360px]">
        ...
        <Card className="lg:col-span-2">
          <CardHeader title="Video" subtitle="The clip this entry shows on the home page." />
          <CardBody>
            {entry.video ? (
