...
import * as faqSectionService from '../../../services/faqSectionService';
import { DEFAULT_PAGE_SIZE } from '../../../config/constants';
import { errorMessage } from '../../../lib/http';
import { SectionCopyCard } from './SectionCopyCard';
import { fmtDate, relativeTime } from '../../../lib/formatters';
import { STATUS_LABELS, type ContentStatus, type FaqEntry } from '../../../types/homePage';

/**
 * FAQ Section admin - the question list.
 *
...
const EDIT_PATH = '/cms/home-page/faq-section';

/** MAX_FAQ_ENTRIES on the server. Shown as a hint before the 409 fires. */
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the home page FAQ.'
