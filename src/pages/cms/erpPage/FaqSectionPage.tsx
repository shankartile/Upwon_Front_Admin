...
import type { ErpFaqEntry as FaqEntry } from '../../../types/erpPage';
...
const EDIT_PATH = '/cms/products/erp/faq-section';
...
export default function ErpFaqSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This question will start appearing in the ERP page FAQ.'
