...
import type { ErpHeroSlide } from '../../../types/erpPage';

/**
 * ERP hero slider admin - the slide list.
 *
...
const EDIT_PATH = '/cms/products/erp/hero-section';
...
type Pending =
  | { kind: 'delete'; record: ErpHeroSlide }
  | { kind: 'status'; record: ErpHeroSlide; next: ContentStatus };

export default function ErpHeroSectionPage() {
  const [entries, setEntries] = useState<ErpHeroSlide[]>([]);
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This slide will start appearing in the ERP page slider.'
