...
const EDIT_PATH = '/cms/products/erp/trust-section';

/**
 * MAX_ERP_TRUST_ENTRIES on the server. Shown as a hint before the 409 fires.
 *
 * The counter row is capped separately at four, enforced server-side - the
 * marquee can grow past that, the four-up grid cannot.
 */
...
export default function ErpTrustSectionPage() {
      ...
      <ConfirmDialog
        ...
        description={
          pending?.kind === 'delete'
            ...
            : pending?.next === 'ACTIVE'
              ? 'This entry will start appearing in the ERP page proof strip section.'
