...
import type {
  CreateErpTrustEntryInput as CreateTrustEntryInput,
  ErpTrustEntry as TrustEntry,
} from '../../../types/erpPage';
...
const LOGO_ENTITY_TYPE = 'erp_trust_logo';
...
export default function ErpTrustEntryEditPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        toast.success('Entry updated', 'The public ERP page now shows this content.');
      }
      navigate(LIST_PATH);
    } catch (error) {
  ...
  return (
    <>
      <PageHeader
        ...
        description="One entry of the ERP page proof strip card: the copy, a brand logo, and a scale counter."
        actions={
          <Button
            variant="secondary"
